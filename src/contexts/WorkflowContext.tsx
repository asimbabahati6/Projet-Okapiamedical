...
interface WorkflowContextType {
  ...
  prescriptions: Prescription[];
  addConsultation: (c: Omit<DemoConsultation, 'id' | 'consultation_number' | 'created_at' | 'lab_requests' | 'prescriptions'> & { lab_tests?: string[]; medications?: PrescriptionItem[]; priority?: LabRequest['priority'] }) => void;
...
const MOCK_CONSULTATIONS: DemoConsultation[] = [
  ...
  {
    id: 'c2',
    consultation_number: 'CONS-2026-002',
    patient_id: 'p2',
    patient_name: 'Marie-Claire Tshisekedi',
    doctor_name: 'Dr. Amani Katebe',
    consultation_type: 'follow_up',
    consultation_status: 'terminee',
    chief_complaint: 'Douleurs abdominales',
    diagnosis: 'Gastrite aiguë (K29.1)',
    treatment_plan: 'Oméprazole 20mg 1x/j',
  ...
  {
    id: 'c3',
    consultation_number: 'CONS-2026-003',
    patient_id: 'p3',
    patient_name: 'Alain Ilunga',
    doctor_name: 'Dr. Amani Katebe',
    consultation_type: 'routine',
    consultation_status: 'en_cours',
    chief_complaint: 'Contrôle tension artérielle',
    diagnosis: 'Hypertension artérielle (I10)',
    treatment_plan: 'Amlodipine 5mg, suivi dans 1 mois',
...
const MOCK_LAB_REQUESTS: LabRequest[] = [
  {
    ...
    doctor_name: 'Dr. Amani Katebe',
    created_at: new Date(Date.now() - 2 * 3600 * 1000).toISOString(),
    notes: 'Suspicion paludisme — traitement urgent si positif',
  },
  {
    id: 'lr2',
    consultation_id: 'c2',
    order_number: 'LAB-2026-042',
    patient_name: 'Marie-Claire Tshisekedi',
    patient_id: 'p2',
    tests: ['Hépatobilan', 'Lipase', 'Amylase'],
    priority: 'normal',
    status: 'en_cours',
    doctor_name: 'Dr. Amani Katebe',
    created_at: new Date(Date.now() - 4 * 3600 * 1000).toISOString(),
  },
  {
    id: 'lr3',
    consultation_id: 'c3',
    order_number: 'LAB-2026-043',
    patient_name: 'Alain Ilunga',
    patient_id: 'p3',
    tests: ['Ionogramme', 'Créatinine', 'Urée'],
    priority: 'normal',
    status: 'termine',
    doctor_name: 'Dr. Amani Katebe',
  ...
  },
  {
    id: 'lr4',
    consultation_id: 'c2',
    order_number: 'LAB-2026-044',
    patient_name: 'Marie-Claire Tshisekedi',
    patient_id: 'p2',
    tests: ['Sérologie Helicobacter pylori'],
    priority: 'urgent',
    status: 'en_attente',
    doctor_name: 'Dr. Amani Katebe',
    created_at: new Date(Date.now() - 1 * 3600 * 1000).toISOString(),
    notes: 'Gastrite récidivante',
  },
];
...
const MOCK_PRESCRIPTIONS: Prescription[] = [
  {
    ...
    doctor_name: 'Dr. Amani Katebe',
    items: [
      { name: 'Artémether-luméfantrine 80/480mg', dosage: '2 comprimés', frequency: '2x/jour', duration: '3 jours' },
      { name: 'Paracétamol 500mg', dosage: '1 comprimé', frequency: '3x/jour si fièvre', duration: '5 jours' },
    ],
    status: 'a_delivrer',
    created_at: new Date(Date.now() - 2 * 3600 * 1000).toISOString(),
  ...
  },
  {
    id: 'pr2',
    consultation_id: 'c2',
    prescription_number: 'ORD-2026-082',
    patient_name: 'Marie-Claire Tshisekedi',
    patient_id: 'p2',
    doctor_name: 'Dr. Amani Katebe',
    items: [
      { name: 'Oméprazole 20mg', dosage: '1 gélule', frequency: '1x/jour avant repas', duration: '14 jours' },
      { name: 'Sucralfate 1g', dosage: '1 sachet', frequency: '3x/jour', duration: '7 jours' },
    ],
    status: 'en_cours',
    created_at: new Date(Date.now() - 4 * 3600 * 1000).toISOString(),
  },
  {
    id: 'pr3',
    consultation_id: 'c3',
    prescription_number: 'ORD-2026-083',
    patient_name: 'Alain Ilunga',
    patient_id: 'p3',
    doctor_name: 'Dr. Amani Katebe',
    items: [
      { name: 'Amlodipine 5mg', dosage: '1 comprimé', frequency: '1x/jour matin', duration: '30 jours' },
    ],
    status: 'delivree',
    created_at: new Date(Date.now() - 24 * 3600 * 1000).toISOString(),
  },
