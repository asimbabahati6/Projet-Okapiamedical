    ...
    <div className="flex h-screen bg-gray-100">
      <aside className="w-64 bg-white shadow-lg flex flex-col">
        <div className="p-6 border-b">
          <h1 className="text-2xl font-bold text-teal-600">MediCare Pro</h1>
          <p className="text-sm text-gray-600 mt-1">Espace Patient</p>
        </div>
                      ...
                      {notifications.slice(0, 10).map((notification) => (
                        <div
                          ...
                          onClick={() => {
                            ...
                            } else if (notification.data?.lab_order_id) {
