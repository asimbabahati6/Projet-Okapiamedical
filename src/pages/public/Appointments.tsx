...
export function Appointments({ preselectedDoctorId }: AppointmentsProps = {}) {
  ...
  return (
    <>
      ...
      <div className="bg-white/80 backdrop-blur-sm border-b border-line sticky top-0 z-20">
        <div className="max-w-2xl mx-auto px-4 py-3 flex flex-wrap items-center justify-center gap-2">
          <button
            onClick={() => setShowLookup(true)}
            className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-full border border-line text-ink-muted hover:text-ink hover:bg-sand transition-colors"
          >
